package org.ruoyi.knowledge.ingestion.service;
...
public interface VectorStoreService {
     ...
     */
    default void storeEmbeddings(StoreEmbeddingBo storeEmbeddingBo, org.ruoyi.knowledge.ingestion.service.IAttachProcessService attachProcessService) throws ServiceException {
        //默认实现：调用原方法（向后兼容）
